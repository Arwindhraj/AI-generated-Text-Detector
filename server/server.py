...
def pdfprocess(file):
    ...
    if average_label == '1 stars' or average_label == '2 stars':
        result = f'The Given text has been generated by Human {average_score:.2f}'
    elif average_label == '3 stars' or average_label == '4 stars' or average_label == '5 stars':
        result = f'The Given text has been generated by an AI and score is {average_score:.2f}'
    return result
